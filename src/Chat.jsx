...
export default function Chat() {
  ...
  function connectToWs() {
    const ws = new WebSocket('https://mern-chat-backend-c87i.onrender.com');
    setWs(ws);
  ...
  function logout() {
    axios.post('https://mern-chat-backend-c87i.onrender.com/logout').then(() => {
      setWs(null);
      setId(null);
      setUsername(null);
    });
  ...
  function sendMessage(ev, file = null) {
    ...
    if (file) {
      axios.get('https://mern-chat-backend-c87i.onrender.com/messages/' + selectedUserId).then(res => {
  ...
  useEffect(() => {
    axios.get('https://mern-chat-backend-c87i.onrender.com/people').then(res => {
